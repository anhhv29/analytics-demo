...
class NativeInlineManager private constructor(
    ...
    companion object {
        fun newInstance(context: Context, adUnitId: String): NativeInlineManager {
            return NativeInlineManager(context, adUnitId)
        }
    }
}
