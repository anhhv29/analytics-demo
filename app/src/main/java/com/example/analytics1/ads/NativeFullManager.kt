...
class NativeFullManager private constructor(
    ...
    companion object {
        fun newInstance(activity: Activity, adUnitId: String): NativeFullManager {
            return NativeFullManager(activity, adUnitId)
        }
    }
}
