...
import com.example.analytics1.databinding.ActivityNativeMediumSmartBinding
...
class NativeMediumSmartActivity : BaseActivity<ActivityNativeMediumSmartBinding>() {
    override fun getActivityBinding() = ActivityNativeMediumSmartBinding.inflate(layoutInflater)
        ...
        nativeManager?.loadNativeAd { nativeAd ->
            if (nativeAd != null) {
                nativeManager?.loadAdTemplate(
                    nativeAd,
                    R.layout.native_ad_template_medium_smart,
                    binding.layoutAds
                )
            }
        }
